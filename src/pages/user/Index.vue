<template>
    ...
    <div>
        ...
        >
            <q-carousel-slide :name="1" img-src="icons/film 1.jpg" />
            <q-carousel-slide :name="2" img-src="icons/film 2.jpg" />
            <q-carousel-slide :name="3" img-src="icons/film 3.jpg" />
            <q-carousel-slide :name="4" img-src="icons/film 4.jpg" />
        </q-carousel>
    </div>
